...
<body>
    ...
    <div class="outer-div">
     ...
     ?>
            <form method="POST" action="formstudent.php" style="background-color:#fff;width:300px;align-items: center;padding:50px 200px 50px 70px;">
                ...
                <div style="width: 300px;">
                    <p>Already Registered?<a href="studentlogin.php"> Click Here</a></p>
                </div>
            </form>
    </div>
    <div id="footer"></div>
