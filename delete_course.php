<!DOCTYPE<html>
    ...
    <body>
        ...
        <div class="outer-div">
             ...
             {
                echo "<font color='green'>Course Deleted!</font>";
             }
             else if(isset($_GET['msg'])=="Error")
             {
                echo "<font color='red'>Course Not Deleted!</font>";
             }
            echo "<form method='GET' action='delete_course_helper.php' style='background-color:#fff;width:300px;align-items: center;padding:50px 200px 50px 70px;'>";
